...
namespace MiddlewareLifetimes.Middlewares
{
    ...
    /// </summary>
    public class Options1Middlware
    {
        private readonly RequestDelegate _next;

        private readonly ILogger<Options1Middlware> logger;
        ...
        public Options1Middlware(RequestDelegate next, ILogger<Options1Middlware> logger, IOptions<RedisOptions> options)
        {
            this._next = next;
            this.logger = logger;
        ...
        public async Task InvokeAsync(HttpContext context, IOptionsSnapshot<RedisOptions> optionsSnapshot)
        {
            ...
            this.logger.LogInformation("Options App -------------------------------------------");
